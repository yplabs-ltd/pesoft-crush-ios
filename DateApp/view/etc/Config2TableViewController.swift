//
//  Config2TableViewController.swift
//  DateApp
//
//  Created by Daehyun Lim on 2018. 2. 18..
//  Copyright © 2018년 iflet.com. All rights reserved.
//

import UIKit

class Config2TableViewController: UITableViewController {
    ...
    @objc func excuteUpdateMatchTodayAge() {
        ...
        _app.api.updateMatchTodayAge(minAge: Int(self.labelSlider.lowerValue+19), maxAge: Int(self.labelSlider.upperValue+19), apiResponseViewModel: matchTodayAgeModel, loadingViewModel: nil)
...
extension Config2TableViewController: ApiReloadable {
    func reloadApi() {
