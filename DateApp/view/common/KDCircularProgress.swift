...
public class KDCircularProgress: UIView,CAAnimationDelegate {
    ...
    @IBInspectable public var trackColor: UIColor = UIColor(red: 227/255, green: 225/255, blue: 224/255, alpha: 1.0) {
        didSet {
    ...
    public var progressLineWidth: CGFloat = 1.0 {
        didSet {
    ...
    private func setInitialValues() {
        ...
        setColors(colors: UIColor.white)
    }
    ...
    private func refreshValues() {
        ...
        progressLayer.gradientRotateSpeed = gradientRotateSpeed
        progressLayer.glowAmount = glowAmount
        progressLayer.glowMode = KDCircularProgressGlowMode.Forward
        progressLayer.progressThickness = progressThickness/2
        progressLayer.trackColor = trackColor
        progressLayer.trackThickness = trackThickness/2
        progressLayer.progressLineWidth = progressLineWidth
    ...
    public func finishAnimate(completion: ((Bool) -> Void)? = nil) {
        if isAnimating() {
            pauseAnimation()
        }
        animateFromAngle(fromAngle: angle, toAngle: 360, duration: 0.3, relativeDuration: true, completion: { [weak self] isFinish in
    ...
    private class KDCircularProgressViewLayer: CALayer {
        ...
        private struct GlowConstants {
            private static let sizeToGlowRatio: CGFloat = 0
        ...
        override init(layer: Any) {
            ...
            progressLineWidth = progressLayer.progressLineWidth
        }
