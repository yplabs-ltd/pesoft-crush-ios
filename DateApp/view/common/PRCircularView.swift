...
public class RPCircularProgress: UIView {
    ...
    @IBInspectable public var thicknessRatio: CGFloat {
        ...
        set {
            progressLayer.thicknessRatio = pin(value: newValue, minValue: 0.01, maxValue: 1)
            progressLayer.setNeedsDisplay()
        }
    }
    ...
    @IBInspectable public var indeterminateProgress: CGFloat {
        ...
        set {
            progressLayer.indeterminateProgress = pin(value: newValue, minValue: 0.05, maxValue: 0.9)
        }
    }
    ...
    public func enableIndeterminate(enabled: Bool = true, completion: CompletionBlock? = nil) {
        ...
        addIndeterminateAnimation(completion: completion)
    }
    ...
    public func updateProgress(progress: CGFloat, animated: Bool = true, initialDelay: CFTimeInterval = 0, duration: CFTimeInterval? = nil, completion: CompletionBlock? = nil) {
        let pinnedProgress = pin(value: progress)
        if animated {
            ...
            animate(pinnedProgress: progress, currentProgress: currentProgress, initialDelay: initialDelay, duration: animationDuration, completion: completion)
        } else {
            progressLayer.removeAnimation(forKey: AnimationKeys.progress)
...
private extension RPCircularProgress {
    ...
    struct Defaults {
        static let trackTintColor = UIColor(white: 1.0, alpha: 0.0)
        static let progressTintColor = UIColor(red: 242/255, green: 80/255, blue: 59/255, alpha: 1.0)
