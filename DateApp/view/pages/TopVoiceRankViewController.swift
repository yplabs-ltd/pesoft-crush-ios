//
//  TopVoiceRankViewController.swift
//  DateApp
//
//  Created by Daehyun Lim on 2018. 5. 21..
...
class TopVoiceRankViewController : UIViewController, AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    override func viewDidLoad() {
        ...
        let foregroundNotification = NotificationCenter.default.addObserver(forName: NSNotification.Name.UIApplicationWillEnterForeground, object: nil, queue: OperationQueue.main) {
        ...
        replyRecordVoiceSegue = DSegue(source: self, destination: { () -> (destination: UIViewController, style: DSegueStyle)? in
            let destination = UIViewController.viewControllerFromStoryboard(name: "Popup", identifier: "NewVoiceRecordPopupController") as! NewVoiceRecordPopupController
            destination.isPassAfterReply = false
            let style = DSegueStyle.PresentPopup(sizeHandler: { (parentSize) -> CGSize in
                return CGSize(width: 294.0, height: 448.5)
            })
        ...
        _app.userVoiceOneViewModel.model = userVoiceOneModel
    }
...
extension TopVoiceRankViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        case 0:
            return 38
        case 1:
            return UIScreen.main.bounds.height - 102
        default:
            return 0
        }
    }
...
extension TopVoiceRankViewController: UITableViewDataSource {
